...
// MS: steps:
// 1- COMPILE THIS FILE: gcc mlite_count_instructions.c -o mlite.exe
// 2- GO TO BENCHMARK FOLDER OF CHOICE
// 3- make test_sim
...
//      case 0x26:/*LWR*/  
                         ...
                         //((unsigned int)mem_read(s,4,ptr&~3)>>target); break;
...
void do_debug(State *s)
{
   ...
   for(;;) 
   {
      if(ch != 'n')
      {
         ...
         printf("7=Watch 8=Jump 9=Quit F=Dump FS> ");
      }
      ch = getch();
      if(ch != 'n')
         printf("\n");
