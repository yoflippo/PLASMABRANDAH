...
add wave -noupdate -expand -group TB /multiplier_tb/randomnumber
...
add wave -noupdate -expand -group TB /multiplier_tb/prStimuli/vsequence
...
add wave -noupdate -expand -group TB /multiplier_tb/prStimuli/v_ia2
add wave -noupdate -expand -group TB /multiplier_tb/prStimuli/v_ib2
add wave -noupdate -expand -group TB /multiplier_tb/prStimuli/v_tmp
add wave -noupdate -expand -group TB /multiplier_tb/prStimuli/vRandNumSignedUnsigned
add wave -noupdate -expand -group TB /multiplier_tb/prStimuli/vRandNumHighLow
add wave -noupdate -expand -group TB /multiplier_tb/prStimuli/vResultBig
...
add wave -noupdate -expand -group UUT /multiplier_tb/UUT/mul_plier_cus
add wave -noupdate -expand -group UUT /multiplier_tb/UUT/mul_cand_cus
...
add wave -noupdate -expand -group UUT /multiplier_tb/UUT/baseline
...
WaveRestoreCursors {{Cursor 1} {1487488 ns} 0}
...
update
WaveRestoreZoom {0 ns} {2610631 ns}
